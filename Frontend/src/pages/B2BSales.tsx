                    ...
                    <table className="w-full text-left">
                        <thead>
                            <tr className="text-[10px] font-black uppercase tracking-[0.15em] text-slate-400 border-b border-slate-50">
                                ...
                                <th className="px-8 py-5">Party / GSTIN</th>
                        ...
                        <tbody className="divide-y divide-slate-50">
                            {loading ? (
                                ...
                                <tr key={inv._id} className="group hover:bg-slate-50/50 transition-all cursor-pointer">
                                    ...
                                    <td className="px-6 py-4">
                                        <div className="flex flex-col">
                                            <div className="flex items-center gap-2">
                                                ...
                                                <span className="text-xs font-semibold text-slate-900">{inv.customerName || 'Direct Node'}</span>
                                            </div>
                                            <span className="text-[9px] font-bold text-slate-400 mt-0.5 pl-4 uppercase tracking-tighter">
                                                {inv.customerGstin || 'No GSTIN Registry'}
                                            </span>
                                        </div>
                                    </td>
                                    <td className="px-6 py-4">
                                    ...
                                    <td className="px-6 py-4">
                                        <span className="text-sm font-semibold text-slate-900">₹{(inv.grandTotal || 0).toLocaleString()}</span>
                                    </td>
                                    <td className="px-6 py-4">
